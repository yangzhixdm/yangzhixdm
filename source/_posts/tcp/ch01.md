---
title: 「读书笔记」TCP/IP 网络编程-理解网络编程和套接字
date: 2021-12-22 17:42:38
tags: tcp/ip
description: 网络编程-理解网络编程和套接字.
...
服务器端代码请参见：{% asset_link hello_server.c %}
...
客户端代码请参见：{% asset_link hello_client.c %}
...
代码见：{% asset_link low_wirte.c %}

编译运行：

```shell
gcc low_wirte.c -o wirte
./wirte
```
