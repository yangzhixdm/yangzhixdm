---
title: Vue-初始化
date: 2019-08-18 10:58:27
tags: Vue
description: Vue 初始化过程。
---
...
export function stateMixin (Vue: Class<Component>) {
  ...
  Vue.prototype.$watch = function (
    ...
    console.log('immediate: 方法触发首次执行')
...
_update方法调用__patch__方法进行patch
``` javascript
Vue.prototype._update = function (vnode: VNode, hydrating?: boolean) {
  console.log('_update: 它来了，终于开始更新了')
  const vm: Component = this
  const prevEl = vm.$el
...
``` javascript
installRenderHelpers(Vue.prototype) // 设置vue helper方法
...
Vue.prototype._render = function (): VNode {
  ...
  try {
    ...
    console.log('来了，来了，它来了，就是这里，开始渲染了 render.call')
    // render是一个匿名函数，且由with包含，这里边会涉及到通过proxy调用之前在defineReactive中的get方法，并且使用$createElement创建
